          ...
          <div className="content-box contents-life">
            ...
            <section className="card">
              ...
              <p>
                ...
                사람들에게 용기를 주고 자신감을 겸손하게 만들고 질투를 완화하는
                것 중 세상의 어떤 것도 음악만한 것이 없다.
              </p>
              <h3>어떤 음악이든, 악기이든 환영합니다!</h3>
              <p>
                저희는 가요 Cover 및 자작곡 작곡 등을 할것이며 보컬과, 작사,
                기타 키보드, 등등 자신이 다룰 수 있는 악기가 있다면 과감히
                지원해주세요!
              </p>
              ...
              <div className="btn_wrap">
                <a href="https://forms.gle/dYcgXWTM64geAvUb8">
